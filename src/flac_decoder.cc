...
const FlacDecoder::meta_map_t FlacDecoder::create_meta_map() {
    ...
    m["TOTALTRACKS"] = METATAG_TRACKTOTAL;
    m["DISCNUMBER"] = METATAG_DISCNUMBER;
    m["DISCTOTAL"] = METATAG_DISCTOTAL;
    m["TOTALDISCS"] = METATAG_DISCTOTAL;
    m["ISRC"] = METATAG_ISRC;
    m["MUSICBRAINZ_TRACKID"] = METATAG_MUSICBRAINZ_TRACKID;
    m["MUSICBRAINZ_ALBUMID"] = METATAG_MUSICBRAINZ_ALBUMID;
    m["MUSICBRAINZ_ARTISTID"] = METATAG_MUSICBRAINZ_ARTISTID;
    m["MUSICBRAINZ_ALBUMARTISTID"] = METATAG_MUSICBRAINZ_ALBUMARTISTID;
    m["MUSICBRAINZ_TRMID"] = METATAG_MUSICBRAINZ_ALBUMARTISTID;
    m["MUSICBRAINZ_DISCID"] = METATAG_MUSICBRAINZ_DISCID;
    m["MUSICBRAINZ_RELEASEGROUPID"] = METATAG_MUSICBRAINZ_RELEASEGROUPID;
    m["MUSICBRAINZ_WORKID"] = METATAG_MUSICBRAINZ_WORKID;
    m["MUSICIP PUID"] = METATAG_MUSICIP_PUID;
    m["RELEASESTATUS"] = METATAG_RELEASESTATUS;
    m["RELEASETYPE"] = METATAG_RELEASETYPE;
    m["RELEASECOUNTRY"] = METATAG_RELEASECOUNTRY;
    m["ASIN"] = METATAG_ASIN;
    m["SCRIPT"] = METATAG_SCRIPT;
    m["LABEL"] = METATAG_LABEL;
    m["ALBUMARTISTSORT"] = METATAG_ALBUMARTISTSORT;
    m["LANGUAGE"] = METATAG_LANGUAGE;
    m["CATALOGNUMBER"] = METATAG_CATALOGNUMBER;
    m["MEDIA"] = METATAG_MEDIA;
    m["BARCODE"] = METATAG_BARCODE;
