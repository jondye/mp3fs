...
enum {
    ...
    METATAG_TRACKLENGTH,
    METATAG_ISRC,
    METATAG_MUSICBRAINZ_TRACKID,
    METATAG_MUSICBRAINZ_ALBUMID,
    METATAG_MUSICBRAINZ_ARTISTID,
    METATAG_MUSICBRAINZ_ALBUMARTISTID,
    METATAG_MUSICBRAINZ_TRMID,
    METATAG_MUSICBRAINZ_DISCID,
    METATAG_MUSICBRAINZ_RELEASEGROUPID,
    METATAG_MUSICBRAINZ_WORKID,
    METATAG_MUSICIP_PUID,
    METATAG_RELEASESTATUS,
    METATAG_RELEASETYPE,
    METATAG_RELEASECOUNTRY,
    METATAG_ASIN,
    METATAG_SCRIPT,
    METATAG_LABEL,
    METATAG_ALBUMARTISTSORT,
    METATAG_LANGUAGE,
    METATAG_CATALOGNUMBER,
    METATAG_MEDIA,
    METATAG_BARCODE,
